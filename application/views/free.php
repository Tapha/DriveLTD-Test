...
<div id="menu_bar">
	<div class="container">
		<ul>
			<li><a href="<?php echo $base_url.'free';?>">Login</a></li>
...
<div id="wrapper">
	<!-- Contact area -->
<div>
	<iframe src="https://spreadsheets.google.com/spreadsheet/embeddedform?formkey=dFMzNUVLbzZEZ1gxOWNaTkYtRGhqNlE6MQ" width="760" height="723" frameborder="0" marginheight="0" marginwidth="0">Loading...</iframe>
</div>
</body>
</html>
